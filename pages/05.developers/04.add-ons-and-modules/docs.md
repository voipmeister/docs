...
!!!! Read more about [Laravel Middleware](https://laravel.com/docs/5.5/middleware)
...
After it's generated, you should open the model, and fill in the table name. See the [Laravel Model Documentation](https://laravel.com/docs/5.5/eloquent) for more details on how to work with models.
